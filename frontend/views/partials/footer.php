            ...
            <div class="footer-container">
                <div class="footer-menu left-footer-menu">
                    ...
                    <ul>
                        ...
                        <li class="lastmenu">
							<a href="#" title="Advertise">Quảng cáo</a>
                        </li>
                    </ul>
                </div>
                <div class="footer-menu right-footer-menu">
                    ...
                    <ul>
                        <li class="firstmenu">
							<a href="#" title="Điều kiện & điều khoản">Điều kiện & điều khoản</a>
                        </li>
                        <li>
...
<!--[if lt IE 10]>
<script type="text/javascript" src="<?= Yii::$app->request->baseUrl; ?>js/jquery.placeholder.js"></script>
