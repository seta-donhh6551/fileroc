    ...
    <div class="title_wrapper">
        ...
        <div class="title_wrapper_inner">
            ...
            <div class="title_wrapper_content">
                <h2 class="menu_title">Quản lý tutorial menu</h2>
            </div>
        </div>
        ...
        <div class="section_content_inner minheight">
            <div class="table_tabs_menu">
                <ul class="table_tabs">
                    ...
                    <li><a href="<?= Yii::$app->request->baseUrl.'/categorytutorial/input'; ?>" name=""><span><span>Thêm mới</span></span></a></li>
                </ul>
            </div>
                        ...
                        <table cellpadding="0" cellspacing="0" width="905">
                            <tbody>
                                <tr>
									...
									<th width="100"><a href="#">Ngày tạo</a></th>
                                ...
                                <?php if (isset($listAll) && $listAll != null) { ?>
                                    ...
                                    foreach ($listAll as $items) { ?>
                                        <tr>
                                            <td><?= $stt; ?></td>
                                            <td><a href="<?= Yii::$app->request->baseUrl . '/categorytutorial/input?id=' . $items['id']; ?>"><?= $items['name']; ?></a></td>
                                            <td><?= $items['order']; ?></td>
                                            ...
                                            <td>
                                                <div class="actions_menu">
                                                    <ul>
                                                        <li><a href="<?= Yii::$app->request->baseUrl . '/categorytutorial/input?id=' . $items['id']; ?>" class="edit">Edit</a></li>
                                                        <li><a href="<?= Yii::$app->request->baseUrl . '/categorytutorial/default/delete?id=' . $items['id']; ?>" class="delete">Del</a></li>
                                                    </ul>
                                                </div>
                                            </td>
                                        </tr>
